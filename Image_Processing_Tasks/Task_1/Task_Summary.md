The task is to detect trees, crops, and land using image processing techniques without any machine learning and convert the image into a grayscale image based on the following color code. 
